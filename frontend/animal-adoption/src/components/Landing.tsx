...
const LandingParallax: React.FC = () => {
    ...
    const images = [
        { imgSrc: '/cloud.svg', class: 'absolute z-10 left-1 top-[15%] sm:top-[10%] lg:left-[10%] overflow-hidden opacity-50 w-[20vw] max-w-[150px]', alt: 'cloud', style: cloudStyle },
        { imgSrc: '/cloud2.svg', class: 'absolute z-10 right-10 top-[5%] overflow-hidden opacity-50 w-[30vw] max-w-[300px]', alt: 'cloud2', style: cloud2Style },
        { imgSrc: '/cat1.svg', class: 'absolute z-10 hidden sm:bottom-[25%]  lg:block lg:left-[1%] md:left-[5%] overflow-hidden w-[25vw] max-w-[300px]', alt: 'cat1', style: cat1Style },
        ...
        { imgSrc: '/100Asset-18.png', class: 'absolute z-10 bottom-10 lg:bottom-[10%] left-1 sm:left-[24%] overflow-hidden w-[25vw] max-w-[170px]', alt: 'asset', style: ballStyle },
        { imgSrc: '/ball.png', class: 'absolute z-10 bottom-[15%] left-[45%] overflow-hidden w-[8vw] max-w-[80px]', alt: 'ball', style: ballStyle },
        ...
        { imgSrc: '/grass.svg', class: 'absolute z-0 bottom-48 left-20 overflow-hidden opacity-50 w-[15vw] max-w-[150px]', alt: 'grass', style: grassStyle },
    ...
    return (
        <section
            className="flex gap-4 flex-col w-full h-dvh items-center justify-center relative overflow-hidden"
